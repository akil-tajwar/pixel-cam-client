                    ...
                    <form onSubmit={handleSignup}>
                        <div className='flex gap-5'>
                            <div className='pb-2 w-full'>
                                ...
                                <input className='bg-white text-black rounded p-2 border-slate-300 border w-full' type="text" name="name" id="" required />
                            </div>
                            <div className='pb-2 w-full'>
                                <label className='text-white' htmlFor="email">Email</label><br />
                                <input className=' bg-white text-black rounded p-2 border-slate-300 border w-full' type="email" name="email" id="" required />
                            </div>
                        </div>
                        <div className='flex gap-5'>
                            <div className='pb-2 w-full'>
                                <label className='text-white' htmlFor="password">Password</label><br />
                                <input className='bg-white text-black rounded p-2 border-slate-300 border w-full' type="password" name="password" id="" required />
                            </div>
                            <div className='pb-2 w-full'>
                                <label className='text-white' htmlFor="password">Confirm Password</label><br />
                                <input className='bg-white text-black rounded p-2 border-slate-300 border w-full' type="password" name="confirm" id="" required />
                            </div>
                        </div>
                        <div className='pb-2 w-full'>
